# httpdwin
Windows HTTP server with Python script backend.    
...
NOTE: As of now it runs only from C:\ drive.    
Unpack the HttpdWin.zip to find some test pages and script that was used for validation.    
As of now, Load tests haven't been done.    
There may be memory leaks.   
Does not use MinGW neither does it use MSys or WSL.    

Last Updated : 09/07/2025 or In Indian format 07/09/2025    
